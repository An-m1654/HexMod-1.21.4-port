...
public class BrainsweepRecipeBuilder implements RecipeBuilder {
    ...
    public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> id) {
		...
		recipeOutput.accept(ResourceKey.create(Registries.RECIPE, id.location().withPrefix("brainsweep/")), recipe, advancement.build(id.location().withPrefix("recipes/brainsweep/")));
	}
}
